...
<head>
  ...
  <title>Fashion Feets|ACCOUNT</title>
</head>
...
<div class="container mt-4">
  ...
  <form action="account.php" method="post">
    <div class="form-group">
      ...
      <input type="text" name="username" class="form-control" id="formGroupExampleInput" placeholder="Email / Username"
        Required>
    </div>
    <div class="form-group">
      <label for="formGroupExampleInput2">Password</label>
      <input type="Password" name="password_1" class="form-control" id="formGroupExampleInput2" placeholder="Password"
        Required>
    </div>
  ...
  <div class="mt-4">
    <p>Not Registered ? <a href="./signup.php">Sign Up Now!</a></p>
  </div>

  <div class="mt-4">
    <p>Admin Login? <a href="../crudimg/user/login.php">Admin Panel</a></p>
  </div>
</div>
